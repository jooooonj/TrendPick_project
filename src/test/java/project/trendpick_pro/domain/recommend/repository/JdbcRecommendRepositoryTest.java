...
class JdbcRecommendRepositoryTest extends IntegrationTestSupport {

    @Autowired
    JdbcRecommendRepository jdbcRecommendRepository;
    @Autowired
    ...
    @Test
    @DisplayName("jdbc batch insert 성능 측정")
    void batchInsert(){
        ...
        jdbcRecommendRepository.batchInsert(recommendList);
